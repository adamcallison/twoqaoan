...
def qap_cost_for_annealing(annealing_inputs, permutation):
    ...
    hamiltonian_adjacency = perm_util.permute_array(hamiltonian_adjacency, \
        permutation)
...
def permutation_neighbour_for_annealing(annealing_inputs, current_permutation):
    ...
    new_permutation[swap_pair[0]], new_permutation[swap_pair[1]] = \
        new_permutation[swap_pair[1]], new_permutation[swap_pair[0]]
